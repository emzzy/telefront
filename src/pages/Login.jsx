      ...
      <div className="flex flex-col justify-center min-h-screen">
        <div>
          ...
          <div className="flex justify-center space-x-3 mt-4 font-semibold">
            <button className="flex items-center gap-x-4 border-2 border-gray-300 rounded-lg px-4 py-2 hover:border-tele-blue-dark">
              <img src={googleIcon} className="w-6" alt="Google logo" />
              <p>Google</p>
            </button>
            <button className="flex items-center gap-x-3 border-2 border-gray-300 rounded-lg px-4 py-2 hover:border-tele-blue-dark">
