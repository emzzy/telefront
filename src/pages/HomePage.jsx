  ...
  return (
    <>
      <section className="hero">
        <div className="flex lg:items-center justify-center gap-x-36 py-10 lg:pt-24 lg:pb-24 bg-tele-blue-lighter lg:rounded-br-[20em]">
          <div className="flex flex-col items-center lg:items-start w-4/5 md:w-1/2 lg:w-1/3">
            ...
            <div className="w-fit md:w-full lg:w-fit">
      ...
      <section>
        <div className="flex justify-center items-center gap-x-10 mt-20">
          ...
          />
          <div>
            <h3 className="text-3xl font-semibold w-1/2 mb-5">
